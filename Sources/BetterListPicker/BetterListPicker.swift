...
//extension BetterListPicker where PickerListFooter == EmptyView {
//    public init(_ title: String,
//                selection: Binding<Value>,
//                pickerValues: [Value],
//                listHeader: () -> PickerListHeader) {
//        self.init(title,
//                  selection: selection,
//                  pickerValues: pickerValues,
//                  listHeader: listHeader,
//                  listFooter: { EmptyView() })
//    }
//
//    public init(_ titleKey: LocalizedStringKey,
//                selection: Binding<Value>,
...
//    public init(_ selection: Binding<Value>,
//                pickerValues: [Value],
//                listTitleKey: LocalizedStringKey,
//                listHeader: () -> PickerListHeader,
//                label: () -> Label) {
//        self.init(selection,
//                  pickerValues: pickerValues,
...
//}
//
//extension BetterListPicker where PickerListHeader == EmptyView, PickerListFooter == EmptyView {
//    public init(_ title: String,
//                selection: Binding<Value>,
//                pickerValues: [Value]) {
//        self.init(title,
